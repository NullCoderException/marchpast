...
import { staffTintSvg, staffContoursSvg, gridSvg, seaSvg } from "./terrain.mjs";
import { LAND_CANNAE, RIVER, polyPath, catmull } from "./ground.mjs";
...
export const SCENES = {
  ...
  midway: {
    ...
    strikes: [
      { id: "eb", x: 794, y: 194, heading: 252, formation: "line", arm: "aircraft", state: "engaged", strength: 1, side: 0, name: "Enterprise strike", fact: "engaged", lx: 752, ly: 256, align: "end" },
      { id: "yb", x: 826, y: 306, heading: 246, formation: "line", arm: "aircraft", state: "engaged", strength: 0.85, side: 0, name: "Yorktown strike", fact: "engaged · 85%", lx: 782, ly: 378, align: "end" },
    ],
    moves: [
...
export function scene(key, { kind = "A", moves = "taper", elbow = true, aircraft = false, sea = "chosen", w = 1120, h = 650, bandTop = 560 } = {}) {
  ...
  const legendArms = aircraft && S.strikes ? [...S.arms, "aircraft"] : S.arms;
  s += staffLegend(EXT.x + 22, scaleY - 34, { sides: S.sides, ink, panel: STAFF.panel, sample, arms: legendArms }).svg;
