...
/** The plate's pens: fine dotted track, dashed intent, solid detachment (ADR-0009). */
...
/** Every view, in the order a picker offers them. The first is the default. */
export const VIEWS: readonly View[] = [CHART_PLATE, NIGHT_PLATE, ATLAS];

export const DEFAULT_VIEW: View = CHART_PLATE;

/** The view an id names, or the default when the id is unknown (a hand-edited URL). */
